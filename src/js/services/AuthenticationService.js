...
define([
    ...
    function AuthenticationService($http, $cookieStore, $rootScope, $timeout, UserService, $state) {
        ...
        service.IsNeedAuth = IsNeedAuth;
        service.IsAuthenticated = IsAuthenticated;
        service.GoLogin = GoLogin;
        ...
        function IsNeedAuth(state) {
           var result =  ['login', 'register'].find(function(item){
    ...
    return apps.factory('AuthenticationService', AuthenticationService);
